...
var MedX = /** @class */ (function () {
    function MedX() {
        this.EcnriptionHandler = encription_handler_1.EcnriptionHandler;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _c.Web3Service = _e.sent();
                        _d = MedX._instance;
                        return [4 /*yield*/, ipfs_service_1.IPFSservice.init()];
                    case 2:
                        _d.IPFSservice = _e.sent();
