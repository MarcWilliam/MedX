        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        _a.createdAt = new (_b.apply(Date, [void 0, _d.sent()]))();
                        _c = EncryptedFile_1.EncryptedFile.bind;
                        return [4 /*yield*/, contractInstance.record()];
                    case 5:
                        _a.record = new (_c.apply(EncryptedFile_1.EncryptedFile, [void 0, _d.sent()]))();
                        return [4 /*yield*/, contractInstance.attachments()];
                    case 6:
                        result = (_a.attachments = (_d.sent()).map(function (a) { return new EncryptedFile_1.EncryptedFile(a); }),
                            _a);
